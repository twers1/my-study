...
1) Проект(приложение) на React/ Next/ Nest/ PostreSql / Prisma/ TS - магазин

Исходный код: https://github.com/twers1/ecommerce-shop

Что сделано: 

	1) написаны все сервисы(category - категории, order - заказы, payment - оплата, product - продукты, review - отзывы, statisctics - статистика, user)

	2) написан интерфейс для сервиса заказов(order)

	3) написаны dto типы для нуждающегося сервиса

2) Для себя подкрепляю "сложный" JavaScript(рассматриваются замыкания, асинхронность, промисы, прототип, ключевое слово this) 

Исходный код: https://github.com/twers1/my-study/tree/main/deepJS

3) Также подкрепляю основы C#

	1) работа с классами, инкапсуляция
	2) модификаторы public и private
	3) рассмотрены конструкторы класса и перегрузки самих конструкторов 
	4) ключевое слово this и свойства класса. геттеры и сеттеры
	5) подкрепила информацию о ключевом слове params
	6) изучила частичные классы, методы и типы; методы расширения - extension
Примеры всех примеров можно посмотреть с day23 - day28
Исходный код: https://github.com/twers1/CS-basics 
...
Что сделано: 
	...
	1) добавлены новые библиотеки в клиентскую часть(redux, react-query и тд)

	2) прописаны user.actions и user.slice(для авторизации/регистрации/выхода из системы)

2) C#-основы. Что изучено? - статические классы, конструкторы, методы, поля, ключевые слова const и readonly, инициализация с примерами

Исходный код: https://github.com/twers1/CS-basics

3) Моя учеба. Основы typescript: 

Исходный код: https://github.com/twers1/my-study/tree/main/typescript , рассмотрено много тем, начиная с типов данных, заканчивая утверждениями, декораторами, расширенными типами, дженериками и тд
